...
class MapUiConfig {
  ...
  // When speed is very low (standing / crawling), bearing can feel confusing.
  // Keep the map north-up until we detect movement beyond this speed (m/s).
  static const double cameraBearingEnableMinSpeedMs = 1.2;
