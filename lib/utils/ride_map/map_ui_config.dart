...
class MapUiConfig {
  ...
  static const int polylineShadowWidth = 9;
  // Active route (premium dark slate; avoid pure black).
  static const Color activePolylineColor = Color(0xFF243B53);
  // Outline for contrast on light maps.
  static const Color activePolylineShadowColor = Color(0xFFFFFFFF);
  static const Color completedPolylineColor = Color(0x99AAB4C0);
  static const Color completedPolylineShadowColor = Color(0x1AFFFFFF);
