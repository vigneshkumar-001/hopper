...
class RideStatsController extends GetxController
  ...
  void onUserMapMoveStarted() {
    ...
    // Keep the UI state consistent: once the user takes over the camera,
    // treat it as "overview" until they tap the location button again.
    rideMap.focusMode.value = MapFocusMode.fullTrip;
    _autoFollowTimer?.cancel();
  }
