...
class VehicleDocGuidLines extends StatefulWidget {
  const VehicleDocGuidLines({super.key});

  @override
  State<VehicleDocGuidLines> createState() => _VehicleDocGuidLinesState();
}

class _VehicleDocGuidLinesState extends State<VehicleDocGuidLines> {
  final GuidelinesController controller = Get.put(GuidelinesController());
  @override
  void initState() {
    super.initState();
    controller.guideLines('road-certificate');
  }
